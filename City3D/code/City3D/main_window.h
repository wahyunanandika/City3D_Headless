...
public:
	...
	// Headless mode — dipanggil dari main.cpp kalau ada argumen command line
	// City3D.exe <pointcloud> <footprint> <output>
	void runHeadless(const QString& pcPath, const QString& fpPath, const QString& outPath);
	void writeStatusFile(const QString& outPath, const std::string& status);
